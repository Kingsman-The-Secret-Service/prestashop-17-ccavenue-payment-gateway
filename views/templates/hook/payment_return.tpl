...
<p>
	...
	<br />- {l s='Reference' mod='ccavenue'} : <span class="reference"><strong>{$reference|escape:'html':'UTF-8'}</strong></span>
	<br /><br />{l s='An email has been sent with this information.' mod='ccavenue'}
...
{else}
<h3>{l s='Your order on %s has not been accepted.' sprintf=$shop_name mod='ccavenue'}</h3>
<p>
	<br />- {l s='Reference' mod='ccavenue'} <span class="reference"> <strong>{$reference|escape:'html':'UTF-8'}</strong></span>
	<br /><br />{l s='Please, try to order again.' mod='ccavenue'}
	<br /><br />{l s='If you have questions, comments or concerns, please contact our' mod='ccavenue'} <a href="{$link->getPageLink('contact', true)|escape:'html':'UTF-8'}">{l s='expert customer support team.' mod='ccavenue'}</a>
</p>
{/if}
<hr />